<template>
  <div class="dashboard" ref="dashboard">
          ...
          <b-row no-gutters>
            ...
            <b-col cols="12" sm="12" md="6" lg="4">
              <graph-view
                ...
                ref="graphView"
                :key="graphViewKey"
                class="component w-100"
              ></graph-view>
            </b-col>
            <b-col cols="12" sm="12" md="6" lg="4">
              <cluster-manager
                id="clusterManagerView"
                :key="clusterManagerKey"
                class="component h-50 w-100"
              ></cluster-manager>
              <word-similarity
                id="wordSimilarityView"
                :key="wordSimilarityKey"
                class="component h-50 w-100"
              ></word-similarity>
            </b-col>
          </b-row>
      ...
      <div class="d-block text-center">
        <b-list-group>
          ...
          <b-list-group-item
            ...
            @click="callCluster"
          >
            <font-awesome-icon :icon="['fas', 'plus']" />&nbsp; Start a new
            session
          </b-list-group-item>
        </b-list-group>
        <br />
            ...
            <div class="d-flex w-100 justify-content-between">
              ...
              <small>
                ...
                <b-button-group size="sm">
                  ...
                  >
                    <font-awesome-icon :icon="['fas', 'download']" />&nbsp; Load
                    session
                  </b-button>
                  <b-button
                    class="ml-2"
    ...
    >
      <div class="d-block text-center">
        <h6>
          Before you can start to explore your corpus, you need to process it!
      ...
      <b-button
        ...
        to="/corpus"
      >
        <font-awesome-icon :icon="['fas', 'book']" />&nbsp; Yes, take me to
...
export default {
  ...
  methods: {
    ...
    callGetSession(id) {
      ...
      this.sessionData
        .then(() => {
          objRef.makeToast("Success", "Session retrieved", "success");
        })
        .catch(() => {
          objRef.makeToast(
            "Error",
    ...
    callCluster() {
      ...
      const cluster_k = prompt(
        "Please, inform the number of clusters you want to find:"
      );
    ...
    callDeleteSession(session) {
      ...
      if (
        confirm(
          `You're about to delete session "${session.name}", are you sure?`
        )
      ) {
